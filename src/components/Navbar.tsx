...
import { BrickWall, User, Briefcase, Mail, ShoppingBag, Settings } from "lucide-react";
    ...
    <nav className="bg-lego-yellow border-b-4 border-black p-4">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <div className="flex gap-4">
          ...
          <Link to="/admin" className="flex items-center gap-1 hover:text-lego-blue transition-colors">
            <Settings size={18} /> 管理
          </Link>
        </div>
      </div>
